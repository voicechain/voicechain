...
from test_framework.test_framework import VoiceTestFramework
...
class LLMQCoinbaseCommitmentsTest(VoiceTestFramework):
    def __init__(self):
    ...
    def run_test(self):
        ...
        # Register one more MN, but don't start it (that would fail as VoiceTestFramework doesn't support this atm)
