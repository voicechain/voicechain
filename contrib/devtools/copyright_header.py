...
Arguments:
    <base_directory> - The base directory of a Voice Core source code repository.
...
YEAR = "20[0-9][0-9]"
YEAR_RANGE = '(%s)(-%s)?' % (YEAR, YEAR)
HOLDER = 'The Voice Core developers'
...
Arguments:
    <base_directory> - The base directory of Voice Core source code repository.
"""
...
Arguments:
    <file> - A source file in the Voice Core repository.
"""
