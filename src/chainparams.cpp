...
// Copyright (c) 2021 The Voice Core developers
 ...
 * database.
 *
 * CBlock(hash=00000ffd590b14, ver=1, hashPrevBlock=00000000000000, hashMerkleRoot=e0028e, nTime=1612577109, nBits=1e0ffff0, nNonce=2346425, vtx=1)
...
{
    const char* pszTimestamp = "The Times 04 Feb 2021 Vaccines Could Blunt U.K. Epidemic in Weeks";
    const CScript genesisOutputScript = CScript() << ParseHex("040676830922ed18f0b8307e6640f03c3cafff27bd6adc3ad7b22e2c6ecd946033e6a4ebbecb78e623c6496453dd2c190b28cb1888705f5e5df7cf49b3f90711bc") << OP_CHECKSIG;
...
public:
    CMainParams() {
        strNetworkID = "main";
        consensus.nSubsidyHalvingInterval = 1800000; 
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_DIP0003].nWindowSize = 3;
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_DIP0008].nWindowSize = 3;
        ...
        consensus.defaultAssumeValid = uint256S("0x000004349f95c4f4fc789da3dfa56d7075c94da4742089c0622cf65de3cf80c8"); 
        ...
        vAlertPubKey = ParseHex("04db5d00d58579ea86b5030ac3042ce3e4cd84e3ca19a757195f0405978e1249b150c6f472acd6fd12bde90f8a731c0281a39b71476303fb935b1f73f9718f70c9");
        nDefaultPort = 28888;
        nPruneAfterHeight = 100000;

        genesis = CreateGenesisBlock(1612577109, 2346425, 0x1e0ffff0, 1, 25 * COIN);
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x000004349f95c4f4fc789da3dfa56d7075c94da4742089c0622cf65de3cf80c8"));
        ...
        // Voice BIP32 pubkeys start with 'xpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x88)(0xB2)(0x1E).convert_to_container<std::vector<unsigned char> >();
        // Voice BIP32 prvkeys start with 'xprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x88)(0xAD)(0xE4).convert_to_container<std::vector<unsigned char> >();

        // Voice BIP44 coin type is '5'
        nExtCoinType = 5;
        ...
        vSporkAddresses = {"VUNhDQMjT9rUhSZYARsE2AEQUvbbFwpoiH"};
        nMinSporkKeys = 1;
        ...
        chainTxData = ChainTxData{
            1612577109, // * UNIX timestamp of last known number of transactions (Block 1068571)
...
public:
    CTestNetParams() {
        ...
        // By default assume that the signatures in ancestors of this block are valid.
        consensus.defaultAssumeValid = uint256S("0x00000fc488a49c2accd33b4fa0e116065d3e83d91df584b066ca93cb9bde9e23"); 

        pchMessageStart[0] = 0xc4;
        pchMessageStart[1] = 0x6f;
        pchMessageStart[2] = 0xf2;
        pchMessageStart[3] = 0x42;
        vAlertPubKey = ParseHex("045231844e3357e6338ddf92a62d31a23ed15c5861459118e7c087f1957a956126f58aad667cdd6b0ac868d6befc7dd25b89eb09847cf513ebb2f05c1a02d5fbde");
        nDefaultPort = 38888;
        nPruneAfterHeight = 1000;

        genesis = CreateGenesisBlock(1612577114UL, 10865UL, 0x1e0ffff0, 1, 25 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x00000fc488a49c2accd33b4fa0e116065d3e83d91df584b066ca93cb9bde9e23"));
        assert(genesis.hashMerkleRoot == uint256S("0x7b1a892798e28456c1738d9a8f89dcb4922aba9a28827df37a0fc58b7943c136"));
        ...
        // Testnet Voice BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Testnet Voice BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x35)(0x83)(0x94).convert_to_container<std::vector<unsigned char> >();

        // Testnet Voice BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
        ...
        vSporkAddresses = {"CVcFnzaiJmnFRmsvEMqwmyHkgEQB6Ssec4"};
        nMinSporkKeys = 1;
        fBIP9CheckMasternodesUpgraded = true;

        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            (    0, uint256S("0x00000fc488a49c2accd33b4fa0e116065d3e83d91df584b066ca93cb9bde9e23"))
        };

        chainTxData = ChainTxData{
            1612577114, // * UNIX timestamp of last known number of transactions (Block 96717)
            0,     // * total number of transactions between genesis and that timestamp
                        //   (the tx=... number in the SetBestChain debug.log lines)
            0        // * estimated number of transactions per second after that timestamp
        };
...
public:
    CDevNetParams() {
        ...
        genesis = CreateGenesisBlock(1612577119, 0, 0x207fffff, 1, 25 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x4cfbbe39284f28e22e89305bd20aa1ee3c41fdc4b40cf3851b4fb02a3b677e35"));
        assert(genesis.hashMerkleRoot == uint256S("0x7b1a892798e28456c1738d9a8f89dcb4922aba9a28827df37a0fc58b7943c136"));
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        //vSeeds.push_back(CDNSSeedData("voiceevo.org",  "devnet-seed.voiceevo.org"));
        ...
        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            (      0, uint256S("0x4cfbbe39284f28e22e89305bd20aa1ee3c41fdc4b40cf3851b4fb02a3b677e35"))
...
public:
    CRegTestParams() {
        ...
        // privKey: 6FQD5cDMr2Hyq3TvtyzDEiHsHpkoqBP1w4gRLjzimSbyK2EbAoT
        vSporkAddresses = {"CfWaBkGzSveXpd7ZJfd9bkL9xBGCtkpTnE"};
        nMinSporkKeys = 1;
        ...
        // Regtest Voice addresses start with 'y'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,28);
        // Regtest Voice script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,29);
        // Regtest private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,156);
        // Regtest Voice BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Regtest Voice BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x35)(0x83)(0x94).convert_to_container<std::vector<unsigned char> >();

        // Regtest Voice BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
