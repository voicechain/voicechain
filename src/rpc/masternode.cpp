...
void masternode_list_help()
{
    throw std::runtime_error(
            ...
            "  owneraddress   - Print the masternode owner Voice address\n"
            "  payee          - Print the masternode payout Voice address (can be additionally filtered,\n"
            "                   partial match)\n"
            "  pubKeyOperator - Print the masternode operator public key\n"
            "  status         - Print masternode status: ENABLED / POSE_BANNED\n"
            "                   (can be additionally filtered, partial match)\n"
            "  votingaddress  - Print the masternode voting Voice address\n"
        );
}
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    { "voice",               "masternode",             &masternode,             true,  {} },
    { "voice",               "masternodelist",         &masternodelist,         true,  {} },
    { "voice",               "getpoolinfo",            &getpoolinfo,            true,  {} },
#ifdef ENABLE_WALLET
    { "voice",               "privatesend",            &privatesend,            false, {} },
#endif // ENABLE_WALLET
};
