...
This mechanism has been integrated into Bitcore-Node-Voice which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/voicepay/insight-api-voice#web-socket-api](https://github.com/voicepay/insight-api-voice#web-socket-api)
* API: [https://github.com/voicepay/insight-api-voice#instantsend-transactions](https://github.com/voicepay/insight-api-voice#instantsend-transactions)
