...
This document provides guidelines for internationalization of the Voice Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `voice_en.ts` remains unchanged.
