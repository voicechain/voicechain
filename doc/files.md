...
* voice.conf: contains configuration settings for voiced or voice-qt
* voiced.pid: stores the process id of voiced while running
* database/*: BDB database environment; only used for wallet
* db.log: wallet database log file
* debug.log: contains debug information and general logging generated by voiced or voice-qt
